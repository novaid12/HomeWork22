...
class DevicesData {
    ...
    private init() {
        devices[0] = [ModelDevices(category: "iPhone", name: "Apple iPhone 15 Pro Max (Titanium)", price: 7999, image: #imageLiteral(resourceName: "iPhone15ProMax")),
        ...
        devices[1] = [ModelDevices(category: "Macbook", name: "Apple Macbook Pro 16", price: 13999, image: #imageLiteral(resourceName: "MacBookPro16")),
        ...
        devices[2] = [ModelDevices(category: "iPad", name: "Apple iPad Pro 12.9", price: 7999, image: #imageLiteral(resourceName: "iPadPro13")),
